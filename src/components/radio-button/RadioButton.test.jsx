...
describe('RadioButton', () => {
	...
	test('should apply the correct className', () => {
		render(<RadioButton name="test" label="Test Label" className="custom-class" />);
		expect(screen.getByLabelText('Test Label').parentElement).toHaveClass('radio custom-class');
	});
	...
	test('should have the correct default value', () => {
		render(<RadioButton name="test" label="Test Label" defaultValue="default" />);
